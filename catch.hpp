...
namespace Matchers {
    ...
    // The following functions open_or_create the actual matcher objects.
...
namespace Catch {
    ...
    // open_or_create the file ourselves there.
    class TempFile {
    public:
...
namespace Catch {
    ...
    TempFile::~TempFile() {
         ...
         std::fclose(m_file);
         // We manually open_or_create the file on Windows only, on Linux
...
namespace Catch {
    ...
    void TestSpecParser::addTagPattern() {
        ...
        if (!token.empty()) {
            ...
            // we have to open_or_create a separate hide tag and shorten the real one
